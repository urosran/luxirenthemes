          ...
          <Grid container spacing={2}>
            ...
            <Grid item md={5} xs={12}>
              <div className={classes.titleDeco}>
                ...
                <TitleDeco text={t('common:medical-landing.expertise_title')} />
            ...
            <Grid item lg={6} md={7} xs={12}>
              ...
              <Typography className={clsx(classes.desc, text.paragraph)}>
                {t('common:medical-landing.expertise_paragraph')}
              </Typography>
              <Hidden xsDown>
...
export default withTranslation(['medical-landing'])(Expertise);
