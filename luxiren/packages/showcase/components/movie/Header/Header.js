        ...
        <Container fixed={isDesktop}>
          <div className={classes.headerContent}>
            ...
            <nav className={clsx(classes.navMenu, classes.navAuth)}>
              <Hidden xsDown>
                <Button href={routeLink.movie.login}>
                  {t('common:movie-landing.header_login')}
                </Button>
                <Button href={routeLink.movie.register} variant="contained" color="secondary" className={classes.button}>
